...
public class MyBotRush
{
    public static HashMap<String,Object> gameDefinitions()
    {
        ...
        gameDefinitions.put("behaviourType",            "RUSH");    // Preset behaviour
        ...
        gameDefinitions.put("rushMaxObjectives",        1);         // Max number of rush objectives issues
        gameDefinitions.put("rushMaxShipsPerObjective", 3);         // Number of ships sent to rush by rush objective
